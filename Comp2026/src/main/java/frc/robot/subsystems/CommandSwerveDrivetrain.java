...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    /****************************************************************************
     *
     * Create pose alignment command for path following
     * 
     * 1) Get the current pose
     * 2) Find the goal pose (use nearest AprilTag)
    ...
    private Command getPoseAlignPPFollowCommand( )
    {
        ...
        return new SequentialCommandGroup( //
                new LogCommand("AlignPosePPFollow", String.format("current %s goal %s", currentPose, goalPose)), //
                AutoBuilder.followPath(path) //
        ).withName("AlignToPosePPFollow");
    }

    /****************************************************************************
     *
     * Create pose alignment command for pathfinding
     * 
     * 1) Get the current pose
     * 2) Find the goal pose (use nearest AprilTag)
    ...
    private Command getAlignToPosePPFindCommand( )
    {
        ...
        return new SequentialCommandGroup( //
                new LogCommand("AlignPosePPFind", String.format("current %s goal %s", currentPose, goalPose)), //
