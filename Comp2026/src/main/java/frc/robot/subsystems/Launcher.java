...
public class Launcher extends SubsystemBase
{
  ...
  private static final double kLauncherAutoRPM   = 3100.0;    // RPM to score for autonomous
  private static final double kLauncherTeleopRPM = 3200.0;    // RPM to score for autonomous
