...
public class Shooter extends SubsystemBase
{
    ...
    public Shooter( )
    {
        ...
        m_lowerValid = PhoenixUtil6.getInstance( ).talonFXInitialize6(m_lowerMotor, kSubsystemName + "Lower",
    ...
    public void periodic( )
    {
        ...
        DataLogManager.log(
                String.format("%s: Angular Velocity %s", getSubsystem( ), m_lowerFlywheelSim.getAngularVelocity( ).toString( )));
